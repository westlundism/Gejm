...
void Player::handleSlashing()
{
    if(temp == sf::IntRect(0, 38, 16, 22) ||
       temp == sf::IntRect(18, 38, 16, 22) ||
       temp == sf::IntRect(34, 38, 16, 22) ||
       temp == sf::IntRect(50, 38, 16, 22))
    {
    ...
    if(temp == sf::IntRect(0, 102, 16, 22) ||
       temp == sf::IntRect(17, 102, 16, 22) ||
       temp == sf::IntRect(33, 102, 16, 22) ||
       temp == sf::IntRect(49, 102, 16, 22))
    {
        if(slash_clock.getElapsedTime() >= sf::seconds(0.6))
            slash_clock.restart();
        if(slash_clock.getElapsedTime() >= sf::seconds(0.1))
    ...
    if(temp == sf::IntRect(0, 6, 16, 22) ||
       temp == sf::IntRect(17, 6, 16, 22) ||
       temp == sf::IntRect(33, 6, 16, 22) ||
       temp == sf::IntRect(49, 6, 16, 22))
    {
        if(slash_clock.getElapsedTime() >= sf::seconds(0.6))
            slash_clock.restart();
        if(slash_clock.getElapsedTime() >= sf::seconds(0.1))
    ...
    if(temp == sf::IntRect(0, 69, 16, 22) ||
       temp == sf::IntRect(16, 69, 16, 22) ||
       temp == sf::IntRect(32, 69, 16, 22) ||
       temp == sf::IntRect(48, 69, 16, 22))
    {
        if(slash_clock.getElapsedTime() >= sf::seconds(0.6))
            slash_clock.restart();
        if(slash_clock.getElapsedTime() >= sf::seconds(0.1))
